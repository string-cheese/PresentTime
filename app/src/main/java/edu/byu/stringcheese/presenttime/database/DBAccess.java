...
public class DBAccess {
    ...
    public static void fakeData(Resources resources)
    {
        ...
        event2b.addItem("Puppy", 600, "Humane Society of Utah", BitmapUtils.encodeResourceToString(resources,R.drawable.puppy, 512, 512), false,40);
        event2b.addItem("Phantom 4 Drone",2000,"Scheels",BitmapUtils.encodeResourceToString(resources,R.drawable.drone, 512, 512), false,10);
        event2b.addItem("KitchenAid Mixer", 230, "Kohls", BitmapUtils.encodeResourceToString(resources,R.drawable.kitchenaid, 512, 512), false,10);
